  ...
  return (
    ...
    <div>
      <div className={classes.content}>
        ...
        <Typography variant="h2" style={{fontWeight: '550', marginLeft: "38vh", color: 'white'}}>About </Typography>
        <img style={{ marginTop: '18px', marginLeft: '18px', height: '60px', width: '130px' }}src={usurpLogo}/>
        </div>
