    ...
    <>
      <Container maxWidth="lg">
        <Paper className={classes.card} elevation={7}>
          ...
          <div>
            <typography variant="body2" className={classes.smallDetails}>Introduction: {Using?.introduction}</typography>
          </div>
          <div>
            <typography variant="body2" className={classes.smallDetails}>Goals: {Using?.goals}</typography>
          </div>
          </Paper>
          <Paper className={classes.IntroPaper}>
          <div className={classes.Details}>
